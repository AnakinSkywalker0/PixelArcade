...
public class TicTacToeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        playerFirst = prefs.getBoolean("ttt_player_first", true);
    ...
    private void showResult(int winner) {
        ...
        if (winner == 1) {
            ...
            // Save win to SharedPreferences
            SharedPreferences prefs = getSharedPreferences("PixelArcadePrefs", MODE_PRIVATE);
            int totalWins = prefs.getInt("wins_ttt", 0);
            prefs.edit().putInt("wins_ttt", totalWins + 1).apply();
